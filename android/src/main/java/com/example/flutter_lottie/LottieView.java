...
public class LottieView implements PlatformView, MethodChannel.MethodCallHandler {
    ...
    private final FlutterPlugin.FlutterPluginBinding mRegistrar;
    ...
    LottieView(Context context, int id, Object args, FlutterPlugin.FlutterPluginBinding registrar) {
        super();
        mContext = context;
        mId = id;
        mArgs = args;
    ...
    void create(Map<String, Object> args) {
        ...
        channel = new MethodChannel(mRegistrar.getBinaryMessenger(), "convictiontech/flutter_lottie_" + mId);
        channel.setMethodCallHandler(this);

        final EventChannel onPlaybackCompleteEventChannel = new EventChannel(mRegistrar.getBinaryMessenger(), "convictiontech/flutter_lottie_stream_playfinish_" + mId);
        ...
        if (args.get("filePath") != null) {
            String key = mRegistrar.getFlutterAssets().getAssetFilePathByName(args.get("filePath").toString());
